  ...
  return (
    <main className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <div className="container mx-auto max-w-5xl px-4 py-12">
        <div className="rounded-[2rem] border border-gray-800 bg-gray-900/70 p-6 sm:p-8">
          <p className="text-xs uppercase tracking-[0.2em] text-gray-500">About Us</p>
          <h1 className="mt-3 text-2xl font-bold text-white sm:text-4xl">About OpeningMaster</h1>
          ...
          <div className="mt-7 grid gap-4 md:grid-cols-2">
            <section className="rounded-3xl border border-gray-800 bg-gray-950/70 p-5">
              <h2 className="text-lg font-semibold text-white">What the website does</h2>
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <Link href="/training" className="rounded-full border border-gray-700 bg-gray-900 px-4 py-2.5 text-sm font-semibold text-gray-100 transition-colors hover:bg-gray-800">
              Open Training Mode
            </Link>
            <Link href="/support" className="rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-2.5 text-sm font-semibold text-cyan-100 transition-colors hover:bg-cyan-500/20">
              Support the Project
            </Link>
          </div>
        </div>
