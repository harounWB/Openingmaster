    ...
    <main className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <div className="container mx-auto max-w-6xl px-4 py-12">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-3 text-2xl font-bold text-white sm:text-4xl">How to Learn Chess Openings Fast</h1>
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2">
          ...
          <article key={topic.title} className="rounded-3xl border border-gray-800 bg-gray-900/70 p-5">
        ...
        <div className="mt-10 rounded-3xl border border-gray-800 bg-gray-900/60 p-6">
          <h2 className="text-xl font-bold text-white">Study flow that works</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-gray-800 bg-gray-950/70 p-4 text-sm leading-6 text-gray-400">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link href="/upload" className="rounded-full bg-purple-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-purple-700">
              Analyze a Game
            </Link>
            <Link href="/openings" className="rounded-full border border-gray-700 bg-gray-900 px-4 py-2.5 text-sm font-semibold text-gray-100 transition-colors hover:bg-gray-800">
              Explore Openings
            </Link>
          </div>
        </div>
