  ...
  return (
    <main className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <div className="container mx-auto max-w-5xl px-4 py-12">
        ...
        <h1 className="mt-3 text-2xl font-bold text-white sm:text-4xl">{opening.title}</h1>
        <p className="mt-4 max-w-3xl text-sm leading-7 text-gray-300 sm:text-base">{opening.description}</p>

        <div className="mt-10 grid gap-4 md:grid-cols-3">
          {opening.plan.map((step, index) => (
            <div key={step} className="rounded-3xl border border-gray-800 bg-gray-900/70 p-5">
        ...
        <div className="mt-10 rounded-3xl border border-gray-800 bg-gray-900/60 p-6">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link href="/training" className="rounded-full bg-purple-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-purple-700">
              Train this opening
            </Link>
