...
export function ChessBoard({
  ...
  return (
    <div className="flex justify-center w-full">
      <div className="w-96 rounded-xl overflow-hidden shadow-2xl border border-white border-opacity-10">
        <div className="w-full h-96 grid grid-cols-8 gap-0">
          {ranks.map((rank) =>
            files.map((file) => {
              ...
              return (
                <button
                  ...
                  disabled={disabled}
                  className="w-full h-full flex items-center justify-center text-5xl font-bold transition-all cursor-pointer hover:opacity-90 disabled:cursor-not-allowed relative"
