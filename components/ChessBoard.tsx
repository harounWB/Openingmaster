...
// Chess.com quality pieces using unicode symbols with perfect styling
const PieceComponent: React.FC<{ type: string; color: 'w' | 'b' }> = ({ type, color }) => {
  ...
  const symbol = pieces[type.toUpperCase()] || '';
  ...
  return (
    <div
      ...
      style={{
        fontSize: '56px',
        lineHeight: '1',
        color: color === 'w' ? '#f0d9b5' : '#312e2b',
        textShadow: color === 'w' 
          ? '1px 1px 0 #1a1a1a, 2px 2px 3px rgba(0,0,0,0.3)'
          : '1px 1px 0 #d9d0c4, 2px 2px 3px rgba(0,0,0,0.5)',
        fontWeight: 'bold',
        userSelect: 'none',
      }}
    >
